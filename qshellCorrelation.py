...
parser.add_argument("-i1","--i1", help="ilim[0]", default=".", type=str)
parser.add_argument("-i2","--i2", help="ilim[1]", default=".", type=str)
parser.add_argument("-j1","--j1", help="jlim[0]", default=".", type=str)
parser.add_argument("-j2","--j2", help="jlim[1]", default=".", type=str)
