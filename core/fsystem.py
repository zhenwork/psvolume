...
class H5manager:
    ...
    @staticmethod
    def writer(fname, keys=None, data=None, chunks=None, compression=None, compression_opts=7,mpi=False):
        """
...
class PVmanager:
    ...
    def reader(fname):
        ...
        for key in dnames:
            utils.dict_merge(params, tempfunc(key, H5manager.reader(fname, key)))
        return params
